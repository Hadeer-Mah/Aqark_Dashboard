                ...
                <div>
                  <div className="sumItem">
                    ...
                    <div className="sumNum">
                      <p>600.88 SAR</p>
                      <div className="percentage percentage0">
                        <TrendingUp />
                        20%
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      >
                        ...
                        <p style={{ fontSize: "11px" }}>
                          يمكنك الاّن طلب تقييم على عقاراتك بكل سهولة وسيقوم
                          خبراءنا في التقييم العقاري بمساعدتك
                        </p>
                      </div>
                ...
                <div className="bottom">
                  <div className="container">
                    <div className="d-flex justify-content-between align-items-baseline">
                      <p>
                        <MenuOpen className="ms-2" />
                        طلباتي
                      </p>
                      <Link
                        to={"/list"}
                        style={{ color: "gray", marginLeft: "10px", fontSize: '16px' }}
                      >
                        رؤية المزيد
                      </Link>
                    </div>
