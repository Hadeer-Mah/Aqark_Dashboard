  ...
  return (
    <>
      <div className="details">
        ...
        {showSidebar ? <Sidebar /> : ""}
        <div
          className={isDesktop ? "detailsContainer" : "detailsContainer mobile"}
        >
          <Navbar styled={{ visibility: "hidden" }} />
          <div className="container">
            <div className="row">
                ...
                <div>
                  <div className="d-flex justify-content-between mb-4">
                    ...
                    <div className="d-flex justify-content-between">
                      <div
                        className={`${
                          userDetails?.status == 0 ? "Pending" : "Approved"
                        } text-center d-flex align-items-center px-3 rounded-2 text-dark fw-bold`}
                      >
                        {userDetails?.status == 0 ? "طلب معلق" : "طلب مغلق"}
                      </div>
                ...
                <div className="row d-flex justify-content-between mt-3">
                  <div className="rightList col-lg-6">
                    ...
                    <div className="mb-4">
                      ...
                      <p>
                        {userDetails.created
                          ? userDetails.created.slice(0, 10)
                          : ""}
                      </p>
                    </div>
                    <div className="mb-4">
                      ...
                      <br />
                      <p>
                        {userDetails?.owner?.identification_number
                          ? userDetails?.owner?.identification_number
                          : ""}
                      </p>
                    </div>
                  ...
                  <div className="leftList col-lg-6">
                    ...
                    <div className="mb-4">
                      ...
                      <br />
                      {userDetails.owner?.identification_image ? (
                        <>
                          <a
                            href={userDetails.owner?.identification_image}
                            download
              ...
              <div className="col-lg-5 left d-flex flex-column justify-content-between ps-2 pt-5">
